 ...
 */
public final class Sshs implements BasicCommand<Sshs.Parameters> {

    @CommandRegistration(name = "sshs")
    public static void main(String[] args) {
        BasicCliLauncher.run(args, Parser::new, Sshs::new, o -> o.so);
    }
    ...
    public void exec(Parameters params) throws Exception {
        ...
        List<InformationSet> output = SshsTool.getDefault().create(input, params.spec);
    ...
    static final class Parser extends JOptSimpleArgsParser<Parameters> {
        ...
        private final ComposedOptionSpec<SshsTool.Options> spec = new SshsOptionsSpec(parser);
    ...
    private static final class SshsOptionsSpec implements ComposedOptionSpec<SshsTool.Options> {
        ...
        @Override
        public SshsTool.Options value(OptionSet o) {
            return new SshsTool.Options(o.valueOf(method), o.valueOf(noisy));
        }
    }
}
